...
(function (global, factory) {
    ...
    class Carousel extends BaseComponent {
      ...
      static carouselInterface(element, config) {
        ...
        if (typeof config === 'object') {
            _config = Object.assign(_config, _config);
        //   _config = { ..._config,
        //     ...config
        //   };
        }
      ...
      static dataApiClickHandler(event) {
        ...
        const config = Object.assign(Manipulator.getDataAttributes(target), Manipulator.getDataAttributes(this));
    ...
    class Collapse extends BaseComponent {
      ...
      static collapseInterface(element, config) {
        ...
        const _config = Object.assign(Default$8, Manipulator.getDataAttributes(element), (typeof config === 'object' && config ? config : {}));
    ...
    */
    ...
    class Dropdown extends BaseComponent {
      ...
      _getPopperConfig() {
        ...
        let ret = Object.assign(defaultBsPopperConfig, (typeof this._config.popperConfig === 'function' ? this._config.popperConfig(defaultBsPopperConfig) : this._config.popperConfig));
        return ret;
    ...
    const Default$2 = Object.assign(Tooltip.Default);
    Default$2.placement = "right";
    Default$2.offset = [0, 8];
    Default$2.trigger = "click";
    Default$2.content = "";
    Default$2.template = '<div class="popover" role="tooltip">' + '<div class="popover-arrow"></div>' + '<h3 class="popover-header"></h3>' + '<div class="popover-body"></div>' + '</div>';
    ...
    // };
    const DefaultType$2 = Object.assign(Tooltip.DefaultType);
    DefaultType$2.content = '(string|element|function)';
